...
[FUNCS] = LAYOUT(
  ...
  _______,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  _______,  _______,  _______,  MS_BTN1,  MS_BTN3,  MS_BTN2,  _______,  _______,  _______,
...
[CNTRL] = LAYOUT(
  ...
  _______,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
                      _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______
)
};
